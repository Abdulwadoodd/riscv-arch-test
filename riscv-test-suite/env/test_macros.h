...
#define PTE_SETUP_SV32(virtual_addr, physical_addr, permission_reg, iden_map)    ;\
    ...
    srli s1,s1, 12              ;\
    slli s1, s1, 12  /* Clearing lower 12 bits */           ;\
    srli a1, s1, 2              ;\
    ...
    slli a2, a2, 2            ;\
    STORE_PTE(a0,a1,a2,sw) /* sw a1, < a2 > (x2)  */       ;\
                                    ;\
    LI(t6, iden_map)                ;\
    beqz t6, 1f    /* True for non-identity mapped. False for identity mapped  */        ;\
    srli a1, virtual_addr, 12         ;\
    slli a1, a1, 12                   ;\
    srli a1, a1, 2                    ;\
    or a1, a1, permission_reg        ;\
    j 2f                             ;\
1:  /* PTE data for NON-Identity mapped address translation */         ;\
    srli a1, physical_addr, 10        ;\
    slli a1, a1, 10         ;\
    srli a1, a1, 2          ;\
